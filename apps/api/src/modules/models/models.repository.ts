...
import { ModelRecord, ModelDocument } from '../../database/schemas/model.schema'
import type { IModel } from '@handshake/types'

@Injectable()
export class ModelsRepository {
  constructor(
    @InjectModel(ModelRecord.name) private readonly modelModel: Model<ModelDocument>,
  ) { }

  async findAll(
    filter: { owner?: string; task?: string }
